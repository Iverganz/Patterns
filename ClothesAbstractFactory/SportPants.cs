...
namespace ClothesAbstractFactory
{
	class SportPants : IPants
	{
		...
		public SportPants(float insideLength, float hipGirth, float seamLength)
		{
		...
		public string CalcSize()
		{
			...
			else if (_seamLength < 103)
			{
				return "s";
			}

			else if (_seamLength < 110)
			{
				return "m";
			}

			else if (_seamLength < 116)
			{
				return "l";
			}

			else if (_seamLength < 120)
			{
				return "xl";
			}
